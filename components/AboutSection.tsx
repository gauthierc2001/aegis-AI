          ...
          >
            ...
            <p className="text-lg text-gray-300 font-inter">
              {point}
                          ...
                          {/* 3D Cards Section */}
        <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-16 mb-24 mt-20 max-w-7xl mx-auto" style={{ perspective: '1500px' }}>
