  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="text-center mb-12 sm:mb-16">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight px-4">
      ...
      <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16">
        {bulletPoints.map((point, index) => (
          <motion.div
            key={index}
            className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-black/20 rounded-xl border border-gold/20"
            variants={bulletVariants}
            custom={index}
          >
            <div className="w-2 h-2 sm:w-3 sm:h-3 bg-gold rounded-full flex-shrink-0" />
            <p className="text-sm sm:text-lg text-gray-300 font-inter">
              {point}
            </p>
          </motion.div>
        ))}
                          ...
                          {/* 3D Cards Section */}
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12 mb-16 sm:mb-24 mt-12 sm:mt-20 max-w-7xl mx-auto" style={{ perspective: '1500px' }}>
        
        {/* Burns Card */}
        <motion.div
          className="group relative h-64 sm:h-80 w-full max-w-64 mx-auto"
          style={{ 
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-gold/40 via-gold-light/30 to-gold/20 rounded-2xl blur-3xl group-hover:blur-4xl transition-all duration-700" />
                     ...
                     {/* Metallic Glass effect */}
                       <div className="relative h-full p-4 sm:p-6 bg-gradient-to-br from-black/60 via-black/40 to-black/60 backdrop-blur-2xl border border-gold/40 rounded-2xl shadow-2xl transform-gpu overflow-hidden" style={{ transform: 'translateZ(20px)' }}>
            ...
            <div className="relative z-10 h-full flex flex-col">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                                 <div className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-br from-gold to-gold-light rounded-xl flex items-center justify-center shadow-lg border border-gold/50" style={{ transform: 'translateZ(30px)' }}>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gold" style={{ transform: 'translateZ(25px)' }}>Burns</h3>
              </div>
              <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-300 flex-1">
                <div>
          ...
          <div className="relative h-full p-4 sm:p-6 bg-gradient-to-br from-black/60 via-black/40 to-black/60 backdrop-blur-2xl border border-gold/40 rounded-2xl shadow-2xl transform-gpu overflow-hidden" style={{ transform: 'translateZ(20px)' }}>
            ...
            <div className="relative z-10 h-full flex flex-col">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gold" style={{ transform: 'translateZ(25px)' }}>Buybacks</h3>
              </div>
              <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-300 flex-1">
                <div>
                  <span className="text-gold font-semibold">Goal:</span>
          ...
          <div className="relative h-full p-4 sm:p-6 bg-gradient-to-br from-black/60 via-black/40 to-black/60 backdrop-blur-2xl border border-gold/40 rounded-2xl shadow-2xl transform-gpu overflow-hidden" style={{ transform: 'translateZ(20px)' }}>
            ...
            <div className="relative z-10 h-full flex flex-col">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gold" style={{ transform: 'translateZ(25px)' }}>Airdrops</h3>
              </div>
              <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-300 flex-1">
                <div>
                  <span className="text-gold font-semibold">Goal:</span>
          ...
          <div className="relative h-full p-4 sm:p-6 bg-gradient-to-br from-black/60 via-black/40 to-black/60 backdrop-blur-2xl border border-gold/40 rounded-2xl shadow-2xl transform-gpu overflow-hidden" style={{ transform: 'translateZ(20px)' }}>
            ...
            <div className="relative z-10 h-full flex flex-col">
              <div className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-gold" style={{ transform: 'translateZ(25px)' }}>Redistributions</h3>
              </div>
              <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-300 flex-1">
                <div>
                  <span className="text-gold font-semibold">Goal:</span>
