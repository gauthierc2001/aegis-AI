        ...
        {bulletPoints.map((point, index) => (
          ...
          >
            ...
            <p className="text-lg text-gray-300 font-inter">
             ...
             {/* 3D Cards Section */}
       <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-16 mb-24 mt-20 max-w-7xl mx-auto" style={{ perspective: '1500px' }}>
